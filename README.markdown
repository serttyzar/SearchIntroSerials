...
### CRF
Кастомная реализация CRF ввиду проблем с импортом библиотеки на Kaggle, где обучалась модель:
...
*Пример 1*: Видео `-220020068_456255414.mp4`.
- Предсказание: ![Alt text](pictures/video_test_1.png?raw=true "Title").
- Значение в labels: {"url": "https://vkvideo.ru/video-220020068_456249358", "name": "24 \u0447\u0430\u0441\u0430. 8 \u0441\u0435\u0437\u043e\u043d, 3 \u0441\u0435\u0440\u0438\u044f", "start": "0:00:05", "end": "0:00:15"}
...
- Добавление звуковых эмбеддингов может очень сильно повысить качество, к примеру MFCC или спектрограммы, так как заставка часто имеет яркое звуковое сопровождение
- Эксперименты с другими архитектурами (например, LSTM+CRF).
- Увеличение датасета с добавлением новых видео. Очень важный шаг + более сбалансированный датасет в плане классов.
